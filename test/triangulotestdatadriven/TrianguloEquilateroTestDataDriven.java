...
public class TrianguloEquilateroTestDataDriven {

	int lado1,lado2,lado3;
	String resultado;
	
	public TrianguloEquilateroTestDataDriven(int lado1,int lado2,int lado3,String resultado) {
		this.lado1 = lado1;
		this.lado2 = lado2;
		this.lado3 = lado3;
	...
	public static List<Object[]> data(){
		return Arrays.asList(new Object[][]{
			{2,2,2,interfaces.triangulo.Triangulo.TRIANGULO_EQUILATERO},
